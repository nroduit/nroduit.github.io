...
1. **Media Viewer and Editor**<br>
   This category handles the main viewing and editing functionalities. Except the [2D viewer](../tutorials/dicom-2d-viewer/), it includes [specialized viewers](../tutorials/gui/#other-viewers-and-players) for different modalities and representations.
2. **UI Aggregator**<br>
